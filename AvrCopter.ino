...
unsigned int c = 0; // successful MPU/DMP reads
unsigned int np = 0; // MPU/DMP reads without a packet back
unsigned int err_c = 0; // MPU/DMP reads with corrupted packet
unsigned int err_o = 0; // MPU/DMP reads that had overflow bit set (OVERFLOWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW CARALHO)
